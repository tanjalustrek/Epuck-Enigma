...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/models/urdf/meshes', ['my_simulation/models/urdf/meshes/left_wheel.STL']),
        ('share/' + package_name + '/models/urdf/meshes', ['my_simulation/models/urdf/meshes/main_body.STL']),
        ('share/' + package_name + '/models/urdf/meshes', ['my_simulation/models/urdf/meshes/right_wheel.STL']),
    ...
    package_data={
        'my_simulation': [
            ...
            'models/urdf/meshes/left_wheel.STL',
            'models/urdf/meshes/main_body.STL',
            'models/urdf/meshes/right_wheel.STL',
